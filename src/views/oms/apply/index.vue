  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="输入搜索：">
            <el-input v-model="search.keyword" class="input-width" placeholder="优惠券名字，所属门店"></el-input>
          </el-form-item>
    ...
    <div class="table-container">
      <el-table ref="returnApplyTable"
        ...
        <el-table-column label="优惠券id" width="80" align="center">
          <template slot-scope="scope">{{scope.row.id}}</template>
        </el-table-column>
        <el-table-column label="优惠券名字" width="180" align="center">
          <template slot-scope="scope">{{scope.row.coupon_name}}</template>
        </el-table-column>
        <el-table-column label="有效期" align="center">
          <template slot-scope="scope">{{scope.row.expired_day }}</template>
        </el-table-column>
        <el-table-column label="所属门店" width="180" align="center">
    ...
    <el-dialog
      ...
      <el-form :model="returnReason"
        ...
        <el-form-item label="优惠券名字：">
          <el-input v-model="returnReason.coupon_name" class="input-width"></el-input>
        </el-form-item>
        <el-form-item label="有效期限：">
          <el-input v-model="returnReason.expired_day" class="input-width"></el-input>
        </el-form-item>
        <el-form-item label="可获积分：">
          <el-input v-model="returnReason.integral" class="input-width"></el-input>
        </el-form-item>
        <el-form-item label="折扣力度：">
          <el-input v-model="returnReason.rebate" class="input-width"></el-input>
        </el-form-item>
        <el-form-item label="所属门店：">
          <el-select v-model="listQuery.status" class="input-width" placeholder="务必选择门店" clearable>
...
<script>
  ...
  import {fetchList,deleteApply,updateReason,addReason,SearchList} from '@/api/returnApply';
  import {deleteReason} from "../../../api/returnApply";
