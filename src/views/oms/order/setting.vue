      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="输入搜索：">
            <el-input v-model="search.keyword" class="input-width" placeholder="管理员名字，账号"></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    ...
    <el-dialog
      ...
      <el-form :model="returnReason"
        ...
        <el-form-item label="账号：">
          <el-input v-model="returnReason.account" class="input-width"></el-input>
        </el-form-item>
        <el-form-item label="密码：">
          <el-input v-model="returnReason.password" class="input-width"></el-input>
        </el-form-item>
        <el-form-item label="权限：">
          <el-input v-model="returnReason.admin_type" class="input-width"></el-input>
        </el-form-item>
      </el-form>
...
<script>
  ...
  import {fetchList,deleteApply,updateReason,addReason,SearchList} from '@/api/brand';
  import {deleteReason} from "../../../api/brand";
